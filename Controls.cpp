...
void CCheckBox::Draw(bool hover)
{
	...
	if (hover)
	{
		if (Checked)
		{
			Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(120, 120, 120, 255));
		}
		else
		{
	...
	{
		Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(160, 160, 160, 255));
		Render::Outline(a.x + 2, a.y + 2, 9, 9, Color(20, 20, 20, 80));
	}
}
...
void CSlider::Draw(bool hover)
{
	...
	Render::Clear(a.x + Location, a.y + 1, 4, 9, Color(255, 255, 255, 255));
