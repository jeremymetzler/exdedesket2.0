...
void ClanTag()
{
	...
	case 1:
	{
		...
		switch (value) {
		case 0:SetClanTag("          ", "stick.cc"); break;
		case 1:SetClanTag("         s", "stick.cc"); break;
		case 2:SetClanTag("        st", "stick.cc"); break;
		case 3:SetClanTag("       sti", "stick.cc"); break;
		case 4:SetClanTag("      stic", "stick.cc"); break;
		case 5:SetClanTag("     stick", "stick.cc"); break;
		case 6:SetClanTag("    stick.", "stick.cc"); break;
		case 7:SetClanTag("   stick.c", "stick.cc"); break;
		case 8:SetClanTag("  stick.cc", "stick.cc"); break;
		case 9:SetClanTag(" stick.cc", "stick.cc"); break;
		case 10:SetClanTag("stick.cc ", "stick.cc"); break;
		case 11:SetClanTag("tick.cc  ", "stick.cc"); break;
		case 12:SetClanTag("ick.cc   ", "stick.cc"); break;
		case 13:SetClanTag("ck.cc    ", "stick.cc"); break;
		case 14:SetClanTag("k.cc     ", "stick.cc"); break;
		case 15:SetClanTag(".cc      ", "stick.cc"); break;
		case 16:SetClanTag("cc      ", "stick.cc"); break;
		case 17:SetClanTag("c       ", "stick.cc"); break;
		case 18:SetClanTag("          ", "stick.cc"); break;
		}
		counter++;
	}
	break;
	case 2:
	{
		...
		switch (value) {
		case 0:SetClanTag("whitepwr", "whitepwr"); break;
		case 1:SetClanTag("        ", "whitepwr"); break;
		case 2:SetClanTag("whitepwr", "whitepwr"); break;
		case 3:SetClanTag("        ", "whitepwr"); break;
		case 4:SetClanTag("whitepwr", "whitepwr"); break;
		case 5:SetClanTag("        ", "whitepwr"); break;
		case 6:SetClanTag("whitepwr", "whitepwr"); break;
		case 7:SetClanTag("        ", "whitepwr"); break;
		case 8:SetClanTag("whitepwr", "whitepwr"); break;
		case 9:SetClanTag("        ", "whitepwr"); break;
		case 10:SetClanTag("whitepwr", "whitepwr"); break;
		case 11:SetClanTag("        ", "whitepwr"); break;
		case 12:SetClanTag("whitepwr", "whitepwr"); break;
		case 13:SetClanTag("        ", "whitepwr"); break;
		case 14:SetClanTag("whitepwr", "whitepwr"); break;
		case 15:SetClanTag("        ", "whitepwr"); break;
		case 16:SetClanTag("whitepwr", "whitepwr"); break;
		case 17:SetClanTag("        ", "whitepwr"); break;
		}
		counter++;
	}
	break;
...
void __fastcall PaintTraverse_Hooked(PVOID pPanels, int edx, unsigned int vguiPanel, bool forceRepaint, bool allowForce)
{
	...
	else if (FocusOverlayPanel == vguiPanel)
	{
		...
		Render::Text(10, 10, Color(255, 255, 255, 220), Render::Fonts::Menu, "STICK.CC/whitepwr");
		if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame())
			Hacks::DrawHacks();
...
void  __stdcall Hooked_FrameStageNotify(ClientFrameStage_t curStage)
{
	...
	if (Interfaces::Engine->IsConnected() && Interfaces::Engine->IsInGame() && curStage == FRAME_RENDER_START)
	{
		...
		if ((Menu::Window.MiscTab.OtherThirdperson.GetState()) || Menu::Window.RageBotTab.AccuracyPositionAdjustment.GetState())  Menu::Window.MiscTab.Othersv_cheats.GetState();
		{
